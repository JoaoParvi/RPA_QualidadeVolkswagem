pipeline {
    ...
    stages {
        stage('Clonar o repositório') {
            steps {
                git branch: 'main',
                    url: 'https://github.com/JoaoParvi/RPA_QualidadeVolkswagem.git'
            }
        }
        ...
        stage('Executar script Python') {
            steps {
                bat '''
            C:\\Users\\adm.luiz.vinicius\\AppData\\Local\\Programs\\Python\\Python312\\python.exe QualidadeVolkswagem.py > script_log.txt 2>&1
            type script_log.txt
        '''
    }
}
